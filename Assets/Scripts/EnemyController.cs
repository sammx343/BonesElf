...
public class EnemyController : MonoBehaviour {
    ...
    public float WALKING_SPEED = 4;
    public float ATTACKING_SPEED = 15;
    ...
    void Start ()
    {
        ...
        setVelocity = new Vector2(-WALKING_SPEED, rgdb.velocity.y);
    ...
    private void Angry()
    {
        ...
        {
            rgdb.velocity = new Vector2(ATTACKING_SPEED * -transform.localScale.x, rgdb.velocity.y);
